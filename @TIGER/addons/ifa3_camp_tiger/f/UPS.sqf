...
nul=[this,"town"] execVM "ups.sqf"  // стандарт
nul=[this,"town","nofollow"] execVM "ups.sqf" // охрана зоны
nul=[this,"post1","nofollow","nomove"] execVM "ups.sqf"    // Для стоящих на посту
